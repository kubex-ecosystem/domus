...
// 	cmd.Flags().StringVarP(&initArgs.ConfigFile, "config", "c", os.ExpandEnv(kbx.DefaultKubexDomusConfigPath), "Caminho para o arquivo de configuração")
