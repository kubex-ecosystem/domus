...
// 		)
// 		if err != nil {
// 			return fmt.Errorf("failed to declare queue %s: %v", queue.name, err)
// 		}
...
// 		)
// 		if err != nil {
// 			return fmt.Errorf("failed to bind queue %s to exchange %s: %v", binding.queue, binding.exchange, err)
// 		}
