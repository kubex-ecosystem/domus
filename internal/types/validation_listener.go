...
type ValidationListener struct {
	*Mutexes
	...
	Listeners map[kbx.Reference]map[ValidationListenerType]func(*ValidationResult)
}

func NewValidationListener() *ValidationListener {
	return &ValidationListener{
		Mutexes:   NewMutexesType(),
		Listeners: make(map[kbx.Reference]map[ValidationListenerType]func(*ValidationResult)),
...
func (vl *ValidationListener) AddListener(reference kbx.Reference, listenerType ValidationListenerType, handler func(*ValidationResult)) {
	if vl == nil {
		logz.Log("error", "RegisterListener: ValidationListener is nil")
		return
	}
...
func (vl *ValidationListener) RemoveListener(reference kbx.Reference, listenerType ValidationListenerType) {
	if vl == nil {
		logz.Log("error", "RegisterListener: ValidationListener is nil")
		return
	}
...
func (vl *ValidationListener) GetListeners() map[kbx.Reference]map[ValidationListenerType]func(*ValidationResult) {
	if vl == nil {
		logz.Log("error", "RegisterListener: ValidationListener is nil")
		return nil
	}
...
func (vl *ValidationListener) GetListenersKeys() map[string]kbx.Reference {
	if vl == nil {
		logz.Log("error", "RegisterListener: ValidationListener is nil")
		return nil
	}
	...
	keys := make(map[string]kbx.Reference)
...
func (vl *ValidationListener) RegisterListener(reference kbx.Reference, handler func(*ValidationResult)) {
	if vl == nil {
		logz.Log("error", "RegisterListener: ValidationListener is nil")
		return
	}
