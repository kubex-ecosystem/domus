...
// Property is a struct that holds the properties of the domus instance.
type Property[T any] struct {
	// Telemetry is the telemetry for this domus instance.
	metrics *Telemetry `json:"-" yaml:"-" toml:"-" xml:"-"`
	// Prop is the property for this domus instance.
	prop ci.IPropertyValBase[T] `json:"-" yaml:"-" toml:"-" xml:"-"`
	// Cb is the callback function for this domus instance.
...
// Prop is a struct that holds the properties of the domus instance.
