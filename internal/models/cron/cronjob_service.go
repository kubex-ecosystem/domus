...
// 	jobqueue "github.com/kubex-ecosystem/domus/internal/models/job_queue"
...
// 		logz.Log("error", "Invalid repository type provided to NewCronJobService")
// 		return nil
// 	} else {
...
// func (s *CronJobService[T]) publishToRabbitMQ(ctx context.Context, queueName string, message string) error {
// 	iDBConfig := svc.NewDBConfig(dbConfig)
// 	if iDBConfig == nil {
// 		logz.Log("error", "Failed to create database config")
// 		return errors.New("failed to create database config")
// 	}
// 	url := getRabbitMQURL(iDBConfig)
// 	if url == "" {
// 		logz.Log("error", "Failed to get RabbitMQ URL")
...
// func (s *CronJobService[T]) CreateCronJob(ctx context.Context, job *CronJob) (*CronJob, error) {
// 	if job.Name == "" {
...
// 	if artifact == nil {
// 		logz.Log("error", "Failed to create cron job object")
...
// func (s *CronJobService[T]) GetCronJobByID(ctx context.Context, id uuid.UUID) (*CronJob, error) {
// 	return s.Repo.FindByID(ctx, id)
// }

// func (s *CronJobService[T]) ListCronJobs(ctx context.Context) ([]*CronJob, error) {
// 	return s.Repo.FindAll(ctx)
// }

// func (s *CronJobService[T]) UpdateCronJob(ctx context.Context, job *CronJob) (*CronJob, error) {
// 	if job.ID == uuid.Nil {
...
// func (s *CronJobService[T]) DeleteCronJob(ctx context.Context, id uuid.UUID) error {
// 	if id == uuid.Nil {
...
// func (s *CronJobService[T]) EnableCronJob(ctx context.Context, id uuid.UUID) error {
...
// func (s *CronJobService[T]) DisableCronJob(ctx context.Context, id uuid.UUID) error {
// 	job, err := s.Repo.FindByID(ctx, id)
// 	if err != nil {
// 		return err
// 	}
...
// func (s *CronJobService[T]) ExecuteCronJobManually(ctx context.Context, id uuid.UUID) error {
// 	job, err := s.Repo.FindByID(ctx, id)
// 	if err != nil {
// 		return err
// 	}
...
// func (s *CronJobService[T]) ListActiveCronJobs(ctx context.Context) ([]*CronJob, error) {
...
// func (s *CronJobService[T]) RescheduleCronJob(ctx context.Context, id uuid.UUID, newExpression string) error {
// 	job, err := s.Repo.FindByID(ctx, id)
// 	if err != nil {
// 		return err
// 	}
...
// func (s *CronJobService[T]) ValidateCronExpression(ctx context.Context, expression string) error {
...
// func (s *CronJobService[T]) GetScheduledCronJobs(ctx context.Context) ([]Job, error) {
...
// func (s *CronJobService[T]) GetJobQueue(ctx context.Context) ([]jobqueue.JobQueue, error) {
// 	// Implement logic to fetch the job queue from the repository.
// 	return nil, errors.New("not implemented")
// }

// // ReprocessFailedJobs reprocesses all failed jobs in the queue.
// func (s *CronJobService[T]) ReprocessFailedJobs(ctx context.Context) error {
// 	// Implement logic to reprocess failed jobs.
// 	return errors.New("not implemented")
// }

// // GetExecutionLogs retrieves execution logs for a specific cron job.
// func (s *CronJobService[T]) GetExecutionLogs(ctx context.Context, cronJobID uuid.UUID) ([]jobqueue.ExecutionLog, error) {
...
// func (s *CronJobService[T]) SaveCronJob(ctx context.Context, job *CronJob, defaultUserID uuid.UUID) error {
