...
// 		cron = &CronJob{}
// 	}
// 	cv := NewCronModelValidation(ctx, logz.GetLogger(""), false)
// 	cronV, err := cv.ValidateCronJobProperties(ctx, cron, restrict)
// 	if err != nil {
// 		logz.Log("error", "Failed to validate cron job properties")
// 		return nil
// 	}
// 	if cronV == nil {
// 		logz.Log("error", "Cron job is nil after validation")
// 		return nil
// 	}
// 	return cronV
// }
