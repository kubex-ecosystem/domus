...
// type IJobQueueRepo = datastore.Repository[JobQueueModel]
...
// type JobQueueRepository[T JobQueue] struct {
// 	db *gorm.DB
// }
...
// 	if err != nil {
// 		logz.Log("error", fmt.Sprintf("JobQueueRepository: failed to get DB: %v", err))
// 		return nil
// 	}
// 	return &JobQueueRepository[JobQueue]{db: db}
// }
