...
\ echo 'ETAPA 4: Criando sistema de convites...' -- Partner Invitation
CREATE TABLE IF NOT EXISTS partner_invitation (
    ...
    team_id UUID REFERENCES team(id) ON DELETE
    SET NULL,
...
\ echo '  Tabela partner_invitation criada' -- Internal Invitation
...
\ echo '  Tabela internal_invitation criada' \ echo 'ETAPA 4 concluída com sucesso!'