...
VALUES (
    ...
    'test.superadmin@gnyx.kubex.world',
    'Test',
    'Super Admin',
...
VALUES (
    ...
    'test.salesrep@gnyx.kubex.world',
    'Test',
    'Sales Rep',
    crypt('test123', gen_salt('bf')),
    'active',
...
VALUES (
    ...
    'test.partneradmin@gnyx.kubex.world',
    'Test',
    'Partner Admin',
    crypt('test123', gen_salt('bf')),
    'active',
