...
WHERE category IN ('dashboard', 'leads')
  AND code NOT IN ('leads.delete') ON CONFLICT (role_id, permission_id) DO NOTHING;
...
WHERE category IN ('dashboard', 'partners', 'leads', 'reports')
  AND code NOT IN ('partners.delete', 'leads.delete') ON CONFLICT (role_id, permission_id) DO NOTHING;
...
SELECT '40000000-0000-0000-0000-000000000006',
  ...
  now()
FROM permission
WHERE code IN ('dashboard.view', 'leads.view', 'reports.view') ON CONFLICT (role_id, permission_id) DO NOTHING;
...
WHERE category IN ('dashboard', 'reports')
  OR code IN ('leads.view', 'partners.view', 'users.view') ON CONFLICT (role_id, permission_id) DO NOTHING;
...
SELECT '40000000-0000-0000-0000-000000000008',
  ...
  now()
FROM permission
WHERE code IN ('dashboard.view') ON CONFLICT (role_id, permission_id) DO NOTHING;
-- ================
-- USERS
-- ================
INSERT INTO "user" (
...
VALUES -- Kubex HQ
  ...
  (
    ...
    true,
    now() - interval '2 months'
  ) ON CONFLICT (user_id, tenant_id) DO
UPDATE
